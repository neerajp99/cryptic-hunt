<?php
  ...
  if(isset($_POST['but'])){ 
    ...
    make_log($level[1],$answer,8,$time);
    
    if($answer == "jameshobanwhitehousearchitect"){
      level_up($id,8,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 8</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 8</h1>
        <p>
         <img src="dekh_zara_dhyaan_se.png">
         <br>
         <img src="design_ko_dekh.jpg" height="200px" width="300px">
...
<!-- har time source me thodi kuch hoga xD -->
