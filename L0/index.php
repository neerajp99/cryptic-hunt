<?php
  ...
  if(isset($_POST['but'])){
    ...
    make_log($level[1],$answer,0,$time);
    
    if($answer == "welcometocore10"){
      level_up($id,0,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 0</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 0</h1>
        <p>“I am the one
who told you about this event.
Every detail is important.
Decoding me will give you what we ask.
Finding me is your major task" </p>
