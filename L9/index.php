<?php
  ...
  if(isset($_POST['but'])){ 
    ...
    make_log($level[1],$answer,9,$time);
    
    if($answer == "neerajpandey"){
      level_up($id,9,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 9</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 9</h1>
        <p>
         <strong>8Ju7T4J1qbc</strong> <!-- yet again -->
         <br>
         <br>
         <img src="guru.jpg" width="450px" height="350px">
         <br><br>
          <img src="PqB7r3.png" width="500px">
