<?php
  ...
  if(isset($_POST['but'])){ 
    ...
    make_log($level[1],$answer,4,$time);
    
    if($answer == "france1996"){
      level_up($id,4,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 4</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 4</h1>
        <p>
          <img src = "jo_dikhta_hai_vo_hota_nahi.jpg">
          
          <br> Where did I first <strong>skii</strong>? :/
        </p>
