<?php
  ...
  if(isset($_POST['but'])){ 
    ...
    make_log($level[1],$answer,6,$time);
    
    if($answer == "cliveandrewmantle"){
      level_up($id,6,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 6</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 6</h1>
        <p>
          <img src="mai_irish_hu.jpg" style = "width:500px;">
          <br>
          <br>
          CHVhwcOg6y8 | EQWA
        </p>
