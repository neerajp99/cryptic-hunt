<?php
  ...
  if(isset($_POST['but'])){ 
    ...
    make_log($level[1],$answer,10,$time);
    
    if($answer == "trial-yettoenter"){
      level_up($id,10,$db);
      header("Location: ../play.php");
    }else{
      $rekt = 1;
...
<html>
  <head>
    ...
    <title>enCO&YAcy;E | Level - 10</title>
  ...
  <body>
    ...
    <div class="landing" align="center">
      <div class="landing-box">
        <h1><span class = "orange">L</span>evel - 10</h1>
        <p>
        abhi isme level daalna hai, dummy hai sirf 
